...
hora_dia_habil_vs_fin_de_semana = FOREACH hora_dia_habil_vs_fin_de_semana GENERATE (int)$0 , (int)$1/5 , (int)$2/5 , (int) $4/5, (int) $5/5;
...
-- groupby_temperature_count_avg = ORDER groupby_temperature_count_avg BY $1 DESC;
...
temperature_count_avg_stdev = FOREACH temperature_count_avg_stdev GENERATE $0, $3, $4, $5, $6, SQRT((double) $1/(double)$3);
